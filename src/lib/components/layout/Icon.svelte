<script lang="ts">
	// Minimal SVG icon component. Each icon is stored as a raw SVG inner-HTML string.
	// Follows Lucide conventions: 24x24 viewBox, stroke-based, 2px stroke.
	...
	const icons: Record<string, string> = {
		gauge:
			'<circle cx="12" cy="12" r="10"/><path d="m16.24 7.76-2.12 6.36-6.36 2.12"/><circle cx="12" cy="12" r="1"/>',
		...
		'heart-pulse':
			'<path d="M19.5 12.572l-7.5 7.428-7.5-7.428A5 5 0 0 1 12 6.006a5 5 0 0 1 7.5 6.572z"/><path d="M3.5 12h3l2-4 3 8 2-4h3.5"/>',
		calendar:
		...
		webhook:
			'<path d="M18 16.98h1.5a2.5 2.5 0 1 0 0-5H18"/><path d="M6 16.98H4.5a2.5 2.5 0 0 1 0-5H6"/><path d="M12 3.5v5"/><path d="M12 15.5v5"/><path d="M8 9l4 5.5L16 9"/>',
		'shield-check':
			'<path d="M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.67-.01C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.51 3.81 17 5 19 5a1 1 0 0 1 1 1z"/><path d="m9 12 2 2 4-4"/>',
		package:
			'<path d="m16.5 9.4-9-5.19"/><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"/><polyline points="3.27 6.96 12 12.01 20.73 6.96"/><line x1="12" x2="12" y1="22.08" y2="12"/>',
		'folder-tree':
			'<path d="M20 10a2 2 0 0 0-2-2h-8l-2-2H4a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2z"/><path d="M2 14h20"/>',
		variable: '<path d="M8 21s-4-3-4-9 4-9 4-9"/><path d="M16 3s4 3 4 9-4 9-4 9"/><line x1="15" x2="9" y1="9" y2="15"/>',
		'check-circle':
